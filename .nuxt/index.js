...
import nuxt_plugin_plugin_2e50d508 from 'nuxt_plugin_plugin_2e50d508' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_axios_34ccd5aa from 'nuxt_plugin_axios_34ccd5aa' // Source: .\\axios.js (mode: 'all')
...
import nuxt_plugin_services_4e38a3a3 from 'nuxt_plugin_services_4e38a3a3' // Source: ..\\plugins\\services.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_2e50d508 === 'function') {
    await nuxt_plugin_plugin_2e50d508(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_34ccd5aa === 'function') {
    await nuxt_plugin_axios_34ccd5aa(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_services_4e38a3a3 === 'function') {
